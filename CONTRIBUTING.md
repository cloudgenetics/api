...
Start by pulling down the latest changes from `main`
...
Keep your feature branch fresh and up to date with the latest changes in `main`, use rebase. Every week during the development update the feature branch with the latest changes in main. 
